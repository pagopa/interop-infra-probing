module "probing_ses_identity" {
  source = "git::https://github.com/pagopa/interop-infra-commons//terraform/modules/ses-identity?ref=v1.44.2"
...
module "probing_ses_iam_policy" {
  source = "git::https://github.com/pagopa/interop-infra-commons//terraform/modules/ses-iam-policy?ref=v1.44.2"
