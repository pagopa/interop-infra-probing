...
sso_admin_role_name = "AWSReservedSSO_FullAdmin_010f7fe5de34c177"
fe_base_url         = "https://stato-eservice.uat.interop.pagopa.it"
...
bastion_host_key_pair_name = "interop-probing-bh-uat"
...
openapi_spec_path                                        = "./assets/openapi_spec/interop-probing-uat-api-v1.yaml.tftpl"
...
external_authorizer_uri = "arn:aws:apigateway:eu-central-1:lambda:path/2015-03-31/functions/arn:aws:lambda:eu-central-1:774300547186:function:interop-probing-apigw-lambda-external-authorizer-uat/invocations"
